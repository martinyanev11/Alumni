...
namespace Alumni.Data.Migrations
{
    ...
    [Migration("20250703073515_NOM-UserName")]
    partial class NOMUserName
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Alumni.Data.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2025, 7, 3, 10, 35, 14, 542, DateTimeKind.Local).AddTicks(3722),
                            EndDateTime = new DateTime(2024, 5, 8, 20, 0, 0, 0, DateTimeKind.Unspecified),
                            ImageUrl = "/images/event3.jpg",
                            IsDeleted = true,
                            LastEdited = new DateTime(2025, 7, 3, 10, 35, 14, 542, DateTimeKind.Local).AddTicks(3770),
                            StartDateTime = new DateTime(2024, 5, 8, 17, 30, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            Contents = "The class of 2009 is going to have a meeting at the local pub.",
                            CreatedOn = new DateTime(2025, 7, 3, 10, 35, 14, 542, DateTimeKind.Local).AddTicks(3774),
                            EndDateTime = new DateTime(2024, 5, 8, 20, 0, 0, 0, DateTimeKind.Unspecified),
                            ImageUrl = "/images/event1.jpg",
                            IsDeleted = false,
                            LastEdited = new DateTime(2025, 7, 3, 10, 35, 14, 542, DateTimeKind.Local).AddTicks(3780),
                        ...
                        new
                        {
                            ...
                            ImageUrl = "/images/event1.jpg",
                            IsDeleted = false,
                            LastEdited = new DateTime(2025, 7, 3, 10, 35, 14, 542, DateTimeKind.Local).AddTicks(3788),
                            StartDateTime = new DateTime(2024, 5, 8, 17, 30, 0, 0, DateTimeKind.Unspecified),
                            Title = "Meeting - 2009 class"
                        },
                        new
            ...
            modelBuilder.Entity("Alumni.Data.Models.News", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2025, 6, 2, 10, 35, 14, 542, DateTimeKind.Local).AddTicks(4569),
                            ImageUrl = "/images/event3.jpg",
                            IsDeleted = true,
                            LastEdited = new DateTime(2025, 9, 16, 10, 35, 14, 542, DateTimeKind.Local).AddTicks(4576),
                            Title = "file"
                        },
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2025, 7, 3, 10, 35, 14, 542, DateTimeKind.Local).AddTicks(4580),
                            ImageUrl = "/images/event3.jpg",
                            IsDeleted = false,
                            LastEdited = new DateTime(2025, 7, 3, 10, 35, 14, 542, DateTimeKind.Local).AddTicks(4585),
                            Title = "News"
                        });
                });
            ...
            modelBuilder.Entity("Alumni.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f26ea9c0-3581-4aa0-a426-9b0b451b7ca5",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEO56SwsIaZbMh+v86cSuopTsG3wGdAou1W3i3qwRGjy8ldVtgAzW0v65xopNf96ABg==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7d71707a-433b-43dd-a340-89c65e007fcf",
                            ...
                            LastEdited = new DateTime(2024, 6, 28, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEG5kyf9+6qGpOmSvDQ82QSDCuVA1RlRaMQ7dQdH4NJNFDQeKgbZk0txyoMA5zwvaPw==",
                            PhoneNumberConfirmed = false,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "71777dd4-60b1-4b73-8340-9f8cb1efaecc",
                            CreatedOn = new DateTime(2024, 6, 28, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EmailConfirmed = false,
                            ImageUrl = "asd",
                            IsDeleted = false,
                            ...
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEFrmOwcLiWho5Bq/NwGiG20DmENZ6lnYdMug7Y/tKMMSqjyu2iyYp3IcoYPEsbv3DA==",
                            PhoneNumberConfirmed = false,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8443f418-fc48-43e6-8de1-d7c63f7b88b9",
                            CreatedOn = new DateTime(2025, 7, 3, 10, 35, 14, 664, DateTimeKind.Local).AddTicks(4816),
                            EmailConfirmed = false,
                            ImageUrl = "asd",
                            IsDeleted = false,
                            LastEdited = new DateTime(2025, 7, 10, 10, 35, 14, 664, DateTimeKind.Local).AddTicks(4883),
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEFzyJxrC7rijml4AH6gcAPjwOOmQp29FO5za0gOw1zulhG0cV8UNDFZXBQ7Q3hfcSA==",
                            PhoneNumberConfirmed = false,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7f10a8d4-3225-40a7-8b22-8ef0050f13b8",
                            CreatedOn = new DateTime(2025, 7, 16, 10, 35, 14, 710, DateTimeKind.Local).AddTicks(8727),
                            EmailConfirmed = false,
                            ImageUrl = "asd",
                            IsDeleted = true,
                            LastEdited = new DateTime(2025, 7, 17, 10, 35, 14, 710, DateTimeKind.Local).AddTicks(8786),
                            LockoutEnabled = false,
                            PasswordHash = "AQAAAAIAAYagAAAAEPpyFJmv4EzT/Wx0AmbadQ1Jk8PWszPC4nfsldPmkPaDZdh8S0qx02fK+M5tHZeamg==",
                            PhoneNumberConfirmed = false,
                            TwoFactorEnabled = false,
